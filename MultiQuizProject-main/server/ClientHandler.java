...
public class ClientHandler extends Thread{
    ...
    public ClientHandler(Socket i, int c){
        this.incoming = i;
        this.counter = c;
        this.roomManager = RoomManager.getInstance(); // 객체 참조
        try {
    ...
    public void run(){
        try{
            ...
            while(true){
                ...
                if (mainCommand.equals("QUIZ") && subCommand.equals("REQUEST")) {
                    // 예시 문제
                    String quizData = "다음 중 바다생물이 아닌 것은?|고래|상어|독수리|문어";
                    getOut().println("COMMAND:QUIZ:" + quizData);
                }
